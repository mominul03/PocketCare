...
function UrgencyPill({ level }) {
  ...
  const label = v === "high" ? "High urgency" : v === "low" ? "Low urgency" : "Medium urgency";
              ...
              <div className="mt-6 rounded-2xl border border-gray-200 bg-white p-5">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    onClick={() => navigate(`/appointments?specialty=${encodeURIComponent(result.recommended_specialty || "")}`)}
                  >
                    Find doctors →
                  </button>
                </div>
                ...
                {result.urgency_level === "high" && (
                  <div className="mt-4 rounded-xl border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700 flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="text-red-700/90">If symptoms are severe, call emergency services or visit the nearest ER.</div>
                    </div>
                  </div>
                )}
                ...
                {analysis?.reasoning && (
                  <div className="mt-4">
                    <h3 className="text-sm font-semibold text-gray-900">Why this specialty</h3>
              ...
              {history.length === 0 ? (
                ...
                history.map((h) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600 mt-1">{h.recommended_specialty || "General Practice"}</div>
                  </button>
                ))
              )}
            </div>
